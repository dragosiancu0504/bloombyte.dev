...
document.getElementById('contactForm').addEventListener('submit', function(e) {
    ...
    // Create mailto link
    const mailtoLink = `mailto:office@bloombyte.dev?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
        `Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`
    )}`;
...
window.addEventListener('load', enhanceFloatingAnimation);
